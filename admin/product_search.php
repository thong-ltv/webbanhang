...
//lấy giá trị nhập vào để tìm kiém
            ...
            <form id="post_form" method="post" action="" role="form">
                <div class="col-xs-12">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        {
                        //kiểm tra xem giá trị cần tìm kiếm có tồn tại trong danh sách không
                        $pos = strpos($danhmuc_items['tensp'], $value_search);
                        if($pos > 0){
                        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="product_delete.php?sidd=<?php echo $danhmuc_items['id_sanpham'];?>"><i class="fa fa-times text-danger" ></i></a>
                            </td>
                            <td>
