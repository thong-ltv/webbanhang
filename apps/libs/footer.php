<footer>
    ...
    <ul>
        <li>
            ...
            <p style="color : #D3D3D3">Túi xách - Hàng Đẹp - Hàng Chính Hãng</p>
             <p style="color : #D3D3D3">Tôn vinh người phụ nữ Việt Nam</p> 
        </li>
        <li>
            <div class="text">
                <h4>LIÊN HỆ</h4>
                <div style="color : #C0C0C0">Kênh mua sắm trực tuyến giá tốt hàng đầu Việt Nam</div>
                <br>
                <img alt="100 Ung Văn Khiêm, P.25 Q.Bình Thạnh, TP.HCM<" src="<?php echo $base; ?>/images/icon/pre_footer_icon_address.png">
                <span style="color : #C0C0C0">100 Ung Văn Khiêm, P.25 Q.Bình Thạnh, TP.HCM</span><br>
                <img alt="100 Ung Văn Khiêm, P.25 Q.Bình Thạnh, TP.HCM<" src="<?php echo $base; ?>/images/icon/pre_footer_icon_phone.png">
                <span style="color : #C0C0C0">(+84) 8554 57078</span><br>
                <img alt="100 Ung Văn Khiêm, P.25 Q.Bình Thạnh, TP.HCM<" src="<?php echo $base; ?>/images/icon/pre_footer_icon_email.png">
                <span style="color : #C0C0C0">BelleMode@gmail.com</span>
            </div>
        </li>
        <li>
            ...
            <div class="text">
                ...
                <a style="color : #C0C0C0"; href="">Quy định hình thức thanh toán</a><br>
                <a style="color : #C0C0C0"; href="">Chính sách vận chuyển, giao nhận</a><br>
                <a style="color : #C0C0C0"; href="">Chính sách đổi/trả hàng và hoàn tiền</a><br>
                <a style="color : #C0C0C0"; href="">Chính sách bảo mật</a>
            </div>
        </li>
    </ul>
